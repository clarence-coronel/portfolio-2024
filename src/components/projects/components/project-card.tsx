...
const ProjectCard = ({
  ...
  return (
    <div className="w-full flex justify-center items-center gap-7 max-lg:flex-col max-lg:items-start">
      <div className="max-w-[400px] max-lg:max-w-[350px] w-full h-fit group bg-background rounded-xl overflow-hidden relative justify-center items-center flex">
